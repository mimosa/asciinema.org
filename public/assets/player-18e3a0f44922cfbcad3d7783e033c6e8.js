(function() {
  ...
  Asciinema.Asciicast = (function(_super) {
    __extends(Asciicast, _super);

    function Asciicast() {
      return Asciicast.__super__.constructor.apply(this, arguments);
    }

    Asciicast.prototype.url = function() {
      return "/a/" + (this.get('id')) + ".json";
    };
